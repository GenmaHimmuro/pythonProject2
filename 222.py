...
print('78',translit(num2words(78),language_code="ru"), sep='-')
print('15',translit(num2words(15),language_code="ru"), sep='-')
print('40',translit(num2words(40),language_code="ru"), sep='-')
print('3',translit(num2words(3),language_code="ru"), sep='-')
print('8',translit(num2words(8),language_code="ru"), sep='-')